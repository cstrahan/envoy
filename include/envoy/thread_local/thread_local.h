...
public:
  ...
  /**
   * Set thread local data on all threads previously registered via registerThread(). fixfix
...
public:
  ...
  /**
   * Get a dedicated slot for use in further calls to get() and set(). fixfix
   */
